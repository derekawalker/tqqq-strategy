...
/** Icon for each hedge action kind — the pure builder (lib/hedgeActions.ts) only returns data. */
const HEDGE_ACTION_ICONS: Record<HedgeActionKind, React.ReactNode> = {
  expiring: <IconAlertTriangle size={14} />,
  monetize: <IconCurrencyDollar size={14} />,
  "roll-soon": <IconRefresh size={14} />,
  "roll-later": <IconRefresh size={14} />,
  "vxn-defer": <IconAlertTriangle size={14} />,
  "buy-now": <IconArrowDown size={14} />,
  "buy-later": <IconClock size={14} />,
};
 ...
 */
function NextStepsPanel({ actions }: { actions: HedgeActionItem[] }) {
